...
public class newAccountController {
    ...
    @FXML
    private Label coursesErrorLabel;
    ...
    public void initialize(){
        ...
        Collections.addAll(clist,"Grade 9 Math", "Grade 9 English", "Grade 9 Geography","Grade 9 Science",
                ...
                "Grade 12 Advanced Functions","Grade 12 Calculus and Vectors","Grade 12 Physics","Grade 12 Chemistry","Grade 12 Biology","Grade 12 English","--Select a course--");
    ...
    public void onNextButtonClicked(ActionEvent e){
        ...
        try{
            ...
            Float.parseFloat(newPhoneNumber);
            pass3 = true;
        ...
        try{
            newGrade = newGrade.replaceAll("\\s+", "");
    ...
    public void createNewAccount(ActionEvent e) throws Exception{
        ...
        for (int i = 0; i <boxList.size(); i++){
            try{
                ...
                if(courseStr.contains(tempC)){
                    System.out.println("repeated  courses");
                    coursesErrorLabel.setText("Please select each course ONCE");
                    failed = true;
                }else if(!tempC.equals("--Select a course--")) {
                    if (tempC != null) {
                        if (once) {
        ...
        if(once){
            coursesErrorLabel.setText("No courses were selected, please select at least one");
        }
